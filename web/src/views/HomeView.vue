<template>
  <div class="lightdark ">
      <div class=" row">
        <div class=" col-7">
          <div class="center- all-size">
            <img class="img-size" :src="getImageUrl('logo2.png')" alt="">
          </div>
        </div>
        <div class="col-4 margin">
            <div class="margin- ">
              <button class="button-size" @click="matchClick">
                <p>匹配场</p>
              </button>
            </div>
            <div class="margin-">
            <button class="button-size" @click="rankClick">
              <p>排位场</p>
            </button>
            </div>
        </div>
