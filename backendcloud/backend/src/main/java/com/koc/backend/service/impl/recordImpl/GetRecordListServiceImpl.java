package com.koc.backend.service.impl.recordImpl;
...
public class GetRecordListServiceImpl implements GetRecordListService {
    ...
    public JSONObject getList(Integer page) {
        ...
        for (Record record :
            ...
            String result = "平局";
            if (record.getAId().equals(record.getLoser())) result = userA.getUsername();
            if (record.getBId().equals(record.getLoser())) result = userB.getUsername();
